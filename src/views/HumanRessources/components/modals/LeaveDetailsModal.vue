                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" 
                                tabindex="0" id="Type" v-model="formData.type" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            <label for="deduction" class="form-label">Date fin <span
                                    class="text-danger">*</span></label>
                                    <input class="form-control" type="date" 
                                tabindex="0" id="Type" v-model="formData.date_end" disabled>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <label for="deduction" class="form-label">Attachement <span
                                    class="text-danger">*</span></label>
