...
<template>
  <div class="flex-grow-1 container-fluid mt-3">
    ...
    <Validate
      ...
      title="Demande Recuperée"
      message="Êtes-vous sûr de valider cette demande ?"
      severity="success"
    />
    <DeleteDocModal id="delete-modal" :isLoading="isLoading"
                :method="DeleteDmnd"
                :itemid="rhStore.ItemId"
                title="Supprimer Cette demande"
                message="Êtes-vous sûr de supprimer cet demande ?"
                />
