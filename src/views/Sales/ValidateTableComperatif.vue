          ...
          <div class="card-body">
            <div>
              <div class="d-flex svg-illustration mb-4 gap-2 align-items-center justify-content-between">
                ...
                <div>
                  <button class="btn btn-success d-grid w-100 mb-2 waves-effect d-flex" @click="submit">
                ...
                <tr v-for="article in purchase.purchase_article" :key="article.id">
                  ...
                  <td class="text-center">
                    <select v-model="selectedFournisseurIds[article.id]" class="form-select" style="width: 100%;"
                      required>
                      <option
                        v-for="fournisseur in [getFournisseurById(article.fournisseur1_id), getFournisseurById(article.fournisseur2_id), getFournisseurById(article.fournisseur3_id)]"
