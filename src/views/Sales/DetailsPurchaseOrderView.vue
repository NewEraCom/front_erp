  ...
  <div class="flex-grow-1 container-fluid mt-3">
    <h5 v-if="purchase" class="py-3 mb-4">
      <span class="text-muted fw-light"
        >Dashboard / {{ purchase.type == 'Service' ? "Demande d'execution" : "Demande d'achat" }} /
      </span>
      {{ purchase.n_order }}
    </h5>
        ...
        <div class="card card-border-shadow-primary mb-4">
          ...
          <div v-if="purchase.historique_purchase_order.length > 0" class="card-body m-2">
            <ul class="timeline pt-3">
              <li
                v-for="(historique, index) in purchase.historique_purchase_order"
                :key="historique.id"
                :class="
                  index === purchase.historique_purchase_order.length - 1
                    ? 'border-transparent'
                    : 'border-left-dashed'
                "
          ...
          <div v-else class="card-body text-center m-2">
            ...
            <small class="text-muted"> Aucun historique n'est disponible pour cette demande </small>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            <div class="d-flex justify-content-start align-items-center mb-4">
              ...
              <div class="d-flex flex-column">
                ...
                <small class="text-muted">{{ purchase.created_by.employee.poste }}</small>
              </div>
            </div>
