        ...
        <div class="card">
          <div class="card-body">
            ...
            <form @submit.prevent="submit">
              <div v-if="isError[0] === true" class="alert alert-danger" role="alert" v-html="isError[1]"></div>
              <div class="mb-3">
                <label for="email" class="form-label">Adresse e-mail</label>
                <input id="email" v-model="formData.email" type="text" class="form-control" name="email"
                  placeholder="Entrez votre adresse e-mail" autofocus autosuggest="off" autocomplete="on"
                  :disabled="isLoading" />
              </div>
              <div class="mb-3 form-password-toggle">
                ...
                <div class="input-group input-group-merge">
                  <input id="password" v-model="formData.password" :type="passwordType[1]" class="form-control"
                    name="password" autocomplete="on"
                    placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                    aria-describedby="password" :disabled="isLoading" />
                  <span class="input-group-text cursor-pointer" :disabled="isLoading" @click="togglePwd"><i
                      :class="'ti ' + passwordType[0]"></i></span>
                </div>
              </div>
