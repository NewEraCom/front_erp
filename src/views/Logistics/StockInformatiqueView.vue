...
import { StockTable , AddArticleModal} from './components';
...
onMounted(async () => {
    await logisticsService.getStock('informatique');
});
...
<template>
    <div class="flex-grow-1 container-fluid mt-3">
        <h5 class="py-3 mb-4 fw-medium text-muted">Dashboard / <span class="text-dark">Stock Informatique</span></h5>
        <div v-if="stats" class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <CardTwo title="Total Article" :count="stats.total" color="bg-label-primary" icon="ti ti-recharging"
        ...
        <AddArticleModal type="informatique"/>
    </div>
</template>