          ...
          <div class="card-body mx-3">
            ...
            <div v-if="transport.demande_achat.historique_purchase_order.length > 0" class="card-body m-2">
              <ul class="timeline pt-3">
                <li v-for="(historique, index) in transport.demande_achat.historique_purchase_order"
                  :key="historique.id" :class="index === transport.demande_achat.historique_purchase_order.length - 1
      ? 'border-transparent'
      : 'border-left-dashed'
      ...
      <div class="col-xl-3 col-md-4 col-12 invoice-actions">
        <div class="card card-border-shadow-primary mb-4">
          <div class="card-body">
            ...
            <router-link :to="{ name:'Transports'}" class="btn btn-primary d-grid w-100 mb-2 waves-effect d-flex">
