...
const subscription = ref(computed(() => logisticsStore.subscription));
    ...
    <div class="flex-grow-1 container-fluid mt-3">
        ...
        <div v-if="subscription" class="row">
            <div class="col-xl-4 col-lg-5 col-md-5 order-1 order-md-0">
                ...
                <div class="card mb-4 card-border-shadow-primary">
                    <div class="card-body">
                        ...
                        <div class="info-container">
                            <small class="d-block pt-4 border-top fw-bold text-uppercase text-muted my-3">Affecté à</small>
                            <ul class="list-unstyled">
                                <li class="mb-3 d-flex">
                                    <span class="fw-medium me-2">Employee</span>
                                    <span class="ms-auto">{{ subscription?.currentEmployee }}</span>
                                </li>
                                <li class="mb-3 d-flex">
                ...
                <div v-if="subscription != null" class="card card-border-shadow-primary">
                    <div class="card-body">
                        <div class="card-icon mb-3">
                            <div class="avatar">
            ...
            <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                <div class="card card-border-shadow-primary">
                    <div class="card-header d-flex align-items-center">
                        ...
                        <button class="btn btn-warning ms-auto" data-bs-toggle="modal" data-bs-target="#recover-sim">
                            <i class="ti ti-arrow-back-up me-2"></i> Récupérer
                        </button>
                        <button class="btn btn-primary ms-2" data-bs-toggle="modal" data-bs-target="#new-affectation">
