...
const headers = [
    ...
    { text: 'Solde', value: 'solde', type: 'currency' },
    { text: 'Affecter à', value: 'currentEmployee', type: 'text' },
    { text: 'Date de création', value: 'date_debut', type: 'date' },
    { text: 'Date d\'expiration', value: 'date_fin', type: 'date' },
...
const filteredData = ref(props.jawaz);
...
const filter = () => {
    filteredData.value = props.jawaz.filter((item: any) => {
