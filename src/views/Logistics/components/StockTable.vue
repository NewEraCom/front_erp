...
const headers = [
    ...
    { text: 'Quantité', value: 'qte_restant', type: 'number' },
    { text: 'Prix', value: 'prix_ht', type: 'currency' },
    { text: 'Projet', value: 'preproject', type: 'preproject' },
    { text: 'Status', value: 'qte_restant', type: 'stock' },
    { text: 'Date d\'achat', value: 'date_achat', type: 'date' },
...
const filteredData = ref(props.stock);
...
const filter = () => {
    filteredData.value = props.stock.filter((item: any) => {
