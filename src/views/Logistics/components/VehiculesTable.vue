...
const headers = [
    { text: 'Marque', value: 'brand', type: 'text' },
    { text: 'Model', value: 'model', type: 'text' },
    { text: 'Matricule', value: 'matricule', type: 'text' },
    { text: 'Kiliométrage', value: 'km', type: 'km' },
    { text: 'Date d\'entrée', value: 'date_entree', type: 'date' },
...
const actionsConfig = [
    {
        icon: 'ti ti-eye', class: 'btn btn-primary btn-sm', onClick: (item: any) => {
            router.push({ name: 'DetailsVehicle', params: { id: item.id } });
...
const filteredData = ref(props.vehicules);
...
const filter = () => {
    filteredData.value = props.vehicules.filter((item: any) => {
